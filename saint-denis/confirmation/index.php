<?php
    ...
    if (isset($_SESSION['confirmation'])) {
        ...
        if ($_SESSION['confirmation']['reference_id'] != 'payment') {
            ...
            <p>Réception de la commande au restaurant chicken grill de : '.$_SESSION['actuelPage']['adresse'].'</p>'.$nb.'<p>À bîentôt</p> <p>Chicken grill Saint denis</p><p>'.$tel.'</p>';
        ...
        if (isset($_SESSION['confirmation'])) {
            ...
            <div class="confirmation-content">
                ...
                <?php 
                    if ($_SESSION['confirmation']['reference_id'] != 'payment') {
                        ?>
                        <p style="color: rgb(252, 61, 3);">N'oublier pas de valider le paiement au guichet</p>
                        <?php
                    } 
                    echo $msg;
                ?>
