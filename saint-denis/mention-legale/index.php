<?php
    ...
    $title = 'Mention légale et politique de confidentialité';
...
<div class="mention-legale">
    ...
    <p>La société KTBR, soucieuse des droits des individus, notamment au regard des traitements automatisés et dans une volonté de transparence avec ses clients, a mis en place une politique reprenant l’ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d’actions à la disposition des individus afin qu’ils puissent au mieux exercer leurs droits.<br>Pour toute information complémentaire sur la protection des données personnelles, nous vous invitons à consulter le site : <a href="https://www.cnil.fr/">https://www.cnil.fr/</a>.</p>
    <p>La poursuite de la navigation sur ce site vaut acceptation sans réserve des dispositions et conditions d'utilisation qui suivent.<br>La version actuellement en ligne de ces conditions d'utilisation est la seule opposable pendant toute la durée d'utilisation du site et jusqu'à ce qu'une nouvelle version la remplace.</p>
    <h5>Article 1 - Mentions légales</h5>
    <p class="underline-text">1.1 Site (ci-après « le site ») : </p>
    <a href="https://www.chicken-grill.fr">https://www.chicken-grill.fr</a>
    <p class="underline-text">1.2 Éditeur (ci-après « l'éditeur ») : </p>
    <p>KTBR  Société à responsabilité limitée au capital de 5 000 € dont le siège social est situé : 104 RUE EMILE ZOLA  92600 ASNIERES-SUR-SEINE  représentée par M Abdelkader BENSALAH, en sa qualité de Gérant immatriculée au RCS de NANTERRE 823337472 adresse mail : chickengril .ktbr@gmail.com</p> 
    <p class="underline-text">1.3 Hébergeur (ci-après « l'hébergeur ») :</p>
    <p>CHICKEN GRILL est hébergé par HOSTGATOR, dont le siège social est situé Houston, Texas, États-Unis .</p>
    ...
    <p>La mise en place par les utilisateurs de tous liens hypertextes vers tout ou partie du site est strictement interdite, sauf autorisation préalable et écrite de l'éditeur.<br>L'éditeur est libre de refuser cette autorisation sans avoir à justifier de quelque manière que ce soit sa décision. Dans le cas où l'éditeur accorderait son autorisation, celle-ci n'est dans tous les cas que temporaire et pourra être retirée à tout moment, sans obligation de justification à la charge de l'éditeur.<br>Toute information accessible via un lien vers d'autres sites n'est pas publiée par l'éditeur. L'éditeur ne dispose d'aucun droit sur le contenu présent dans ledit lien.</p>
    <h5>Article 7 - Collecte et protection des données</h5>
    <p>Vos données sont collectées par la société KTBR.<br>Une donnée à caractère personnel désigne toute information concernant une personne physique identifiée ou identifiable (personne concernée) ; est réputée identifiable une personne qui peut être identifiée, directement ou indirectement, notamment par référence à un nom, un numéro d'identification ou à un ou plusieurs éléments spécifiques, propres à son identité physique, physiologique, génétique, psychique, économique, culturelle ou sociale.<br>Les informations personnelles pouvant être recueillies sur le site sont principalement utilisées par l'éditeur pour la gestion des relations avec vous, et le cas échéant pour le traitement de vos commandes.</p>
    ...
    <ul>
        <li>le droit d’accès : ils peuvent exercer leur droit d'accès, pour connaître les données personnelles les concernant, en écrivant à l'adresse électronique ci-dessous mentionnée.<br>Dans ce cas, avant la mise en œuvre de ce droit, la Plateforme peut demander une preuve de l'identité de l'utilisateur afin d'en vérifier l'exactitude ;</li>
    ...
    <p>Vous pouvez exercer ce droit en nous contactant, à l’adresse suivante : 104 RUE EMILE ZOLA  92600 ASNIERES-SUR-SEINE .</p>
    <p>Ou par email, à l’adresse : chickengrill.ktbr@gmail.com</p>
    ...
    <p>Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l'adresse suivante : chickengrill.ktbr@gmail.com</p>
</div>
<?php
