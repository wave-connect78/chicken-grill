<?php
    ...
    if (isset($_SESSION['confirmation'])) {
        ...
        if ($_SESSION['confirmation']['reference_id'] != 'payment') {
            ...
            $nb = '<p>N\'oublier pas de valider le paiement au guichet</p>';
            ...
            <p>Réception de la commande au restaurant chicken grill de : '.$_SESSION['actuelPage']['adresse'].'</p>'.$nb.'<p>À bîentôt</p> <p>Chicken grill Asnieres</p><p>'.$tel.'</p>';
