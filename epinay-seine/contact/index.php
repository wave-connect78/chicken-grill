...
<div class="contactclient">
    ...
    <div class="restaurant">
        ...
        <div class="bloc">
            ...
            <p><i class="fas fa-map-marker-alt"></i>Adresse : 67 rue Gabriel Péri 93200 Saint6Denis</p>
    ...
    <div class="formcontact">
        ...
        <form action="" method="post">
            ...
            <input type="hidden" name="restoemail" class="restoemail" value="chickengrill.93800@gmail.com">
            <div class="mb-3">
