        ...
        if (!isOn()) {
            ...
            if(isset($_POST['codepromo'])){
                ...
                if($resultat->rowCount() > 0){
                   ...
                   $message = '<div class="error">Votre code promo n\'est pas valide. Assurez vous que votre code promo est valide pour le restaurant Chicken grill Epinay-seine</div>';
                }
            } else {
                foreach ($_SESSION['cart'] as $key => $value) {
            ...
            <div class="somme-total">
                <h4 class="mb-4" style="color: rgb(14, 107, 49);">Somme total : <p><?php
                    if(isset($_SESSION['payment'])){
                        $somme = $_SESSION['payment'];
                        echo str_replace('.',',',$somme);
                    }else{
