    ...
    if ($_SESSION['user']['statut'] == 'client') {
        ...
        <div class="profil">
            <div class="profil-content">
                <h3 class="mb-4">Bienvenue dans votre espace personnel</h3>
                ...
                <div class="profil-navigation">
                    ...
                    <div class="item livraison">
                        <div>
                            ...
                            <p>Suivre mes commandes en cours de livraison</p>
                        </div>
                    </div>
                        ...
                        if ($_SESSION['user']['user_google_id'] != '') {
                            ...
                            <div class="item">
                                <div>
                                    ...
                                    <a href="?action=out">Me déconnecter</a>
                                </div>
                            </div>
                            <?php
                        }
                ...
                <div class="delivrary-adresse">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ville" name="ville" placeholder="La ville où vous voulez être livré">
                        </div>
                        <div class="mb-3">
