    ...
    <h2>Nos différents points de vente</h2>
     <div class="restaurant">
        <div class="bloc">
            ...
            <p><i class="fas fa-phone-alt"></i>Tél : 01 47 28 04 60</p>
            <p><i class="fas fa-envelope"></i>Email : <a href="mailto:chickengrill.asnieres@gmail.com">Chicken-grill Asnières</a></p>
        </div>
        <div class="bloc">
        ...
        <div class="bloc">
            ...
            <p><i class="fas fa-phone-alt"></i>Tél : 01 71 67 75 41</p>
